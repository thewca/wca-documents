...
When you make any changes to the recipients, please make this clear at the top of the email. If there is a need to include another team/committee to the thread then begin by writing a “+” along with the name of the team/committee so everyone is aware. When removing someone from a thread they were once a part of you write a “-” followed by their name. For Example:
...
Every WCA Staff member will also have received login credentials for their *@worldcubeassociation.org* email account hosted by GSuite.\
