...
This account must always be used when sending WCA-related emails. The only times exceptions may be made are when the Volunteer has issues with the Google Workspace Software in the region where they live.
