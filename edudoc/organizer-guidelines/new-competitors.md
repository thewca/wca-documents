...
- **Alert competitors about regulation A7g** - Regulation A7g states “At the discretion of the WCA Delegate, an incident or penalty caused by a new competitor's inexperience may be replaced with an extra attempt.” Let them know this! Explain how to call over a Delegate (use this opportunity to introduce your Delegate(s) at your competition, get them to give you a wave or something), and tell them to explain their situation, so the Delegate can make a decision on whether an extra should be granted.
