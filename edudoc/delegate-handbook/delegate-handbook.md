...
6. **Get Files.** Using the password from the previous step, unarchive the `.zip` file. This file will contain the following files related to scramble generation and result submission:
