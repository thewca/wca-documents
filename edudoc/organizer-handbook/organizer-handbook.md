...
- [Before the Competition](#before-the-competition)
  ...
  - [Making the WCA Webpage](#making-the-wca-webpage)
    ...
    - [Scheduling](#scheduling)
      ...
      - [Events and Rounds](#events-and-rounds)
...
<table>
  ...
  <tbody>
    <tr>
      <td>Before the competition:</br>
        Submitting the competition page</br>
        Assisting Organizers</br>
        Ensuring WCA Policies are followed</br>
        Generating scrambles</td>
      <td>Before the competition:</br>
        Making the competition page</br>
        Securing a venue</br>
        Arranging equipment (e.g. timers, mats, scoresheets, puzzle covers, etc.)</br>
        Generating groups and assigning volunteer duties</br></td>
    </tr>
    <tr>
      <td>During the competition:</br>
        Ensuring that the competition follows WCA Regulations and WCA Policies</br>
        Double-checking entered results</td>
      <td>During the competition:</br>
        Giving the first-time competitor tutorial</br>
        Making announcements</br>
        Finding volunteers as needed</br>
        Collecting and putting out score sheets</br>
        Keeping the competition running smoothly</td>
    </tr>
    <tr>
      <td>After the competition:</br>
        Providing feedback to Community organizers</br>
        Ensuring WCA Policies are followed</br>
        Submitting the competition results</br>
        Writing and submitting the Delegate Report</td>
      <td>After the competition:</br>
        Submitting any expenses</br>
