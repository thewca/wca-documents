...
Although this handbook aims to be as complete as possible, it can never be fully comprehensive. While organizing, you will likely run into situations you cannot foresee. As you organize more competitions, you will build a foundation of experience that will allow you to independently handle scenarios not covered in this handbook.

Official competitions have been held in over 100 countries and regions. It is impossible to include specific organizational characteristics and behaviors for every region. This document attempts to include as wide a range of organizer duties as possible.
...
- [Introduction to Organizing](#introduction-to-organizing)
  - [Who Can Organize a Competition?](#who-can-organize-a-competition)
  - [How to Organize a Competition](#how-to-organize-a-competition)
  - [Disclaimer about Regional Differences](#disclaimer-about-regional-differences)
  - [Difference Between an Organizer and a Delegate](#difference-between-an-organizer-and-a-delegate)
  - [Organizer-Delegate Relationship](#organizer-delegate-relationship)
  - [Communication](#communication)
    - [General Email Structure](#general-email-structure)
      - [Subject](#subject)
      - [Greeting](#greeting)
      - [CC or BCC](#cc-or-bcc)
      - [Body](#body)
      - [Sign-Off](#sign-off)
      - [Example Sign-Off](#example-sign-off)
      - [Example Email](#example-email)
    - [Multiple Languages](#multiple-languages)
  - [Confidentiality](#confidentiality)
- [Before the Competition](#before-the-competition)
  - [How to Form a Team and Contact a Delegate](#how-to-form-a-team-and-contact-a-delegate)
    - [Delegates](#delegates)
    - [Co-Organizers](#co-organizers)
    - [Regional Organizations](#regional-organizations)
  - [How to Find a Venue](#how-to-find-a-venue)
    - [Where to Look](#where-to-look)
    - [Basic Requirements](#basic-requirements)
    - [Competition Dates](#competition-dates)
    - [Other Factors to Consider](#other-factors-to-consider)
  - [Running and Judging Systems](#running-and-judging-systems)
    - [Non-Stationary Rounds](#non-stationary-rounds)
    - [Stationary Rounds](#stationary-rounds)
      - [Seated Judges](#seated-judges)
      - [Runners in Non-Stationary Rounds](#runners-in-non-stationary-rounds)
      - [Running Judges in Stationary Rounds](#running-judges-in-stationary-rounds)
    - [What is the Best Way?](#what-is-the-best-way)
    - [Scramble Secrecy](#scramble-secrecy)
  - [Venue Setup](#venue-setup)
    - [Definitions](#definitions)
    - [Check-in Area](#check-in-area)
    - [Competition Area](#competition-area)
    - [Waiting Area](#waiting-area)
    - [Scrambling Table](#scrambling-table)
      - [Scramble Secrecy](#scramble-secrecy)
    - [Score-Taking Table](#score-taking-table)
    - [Spectator Area](#spectator-area)
    - [Enhancements to the Venue Setup](#enhancements-to-the-venue-setup)
  - [Budgeting](#budgeting)
    - [Expenses](#expenses)
  ...
  - [Making the WCA Webpage](#making-the-wca-webpage)
    ...
    - [Scheduling](#scheduling)
      ...
      - [Announcements, Tutorials, and Awards](#announcements-tutorials-and-awards)
      - [Length of Rounds](#length-of-rounds)
      - [Order of Rounds](#order-of-rounds)
      - [Simultaneous Rounds](#simultaneous-rounds)
      - [Finalizing the Schedule](#finalizing-the-schedule)
      - [Making Adjustments to the Schedule](#making-adjustments-to-the-schedule)
  - [Managing Registrations](#managing-registrations)
    ...
    - [Making Changes to the Registration Requirements](#making-changes-to-the-registration-requirements)
    - [Accepting and Managing Competitor Registrations](#accepting-and-managing-competitor-registrations)
  - [Arranging Equipment](#arranging-equipment)
  - [Pre-Competition Email(s)](#pre-competition-emails)
    - [Information Packet](#information-packet)
    - [Cancellation Deadline Reminder](#cancellation-deadline-reminder)
  - [Competition Volunteer Team](#competition-volunteer-team)
    - [Pre-Assigning Volunteer Roles to Competitors](#pre-assigning-volunteer-roles-to-competitors)
    - [Dedicated Volunteer Team](#dedicated-volunteer-team)
    - [Assigning Volunteer Roles On the Spot](#assigning-volunteer-roles-on-the-spot)
    - [Combining Systems](#combining-systems)
    - [General Considerations When Assigning Volunteer Roles](#general-considerations-when-assigning-volunteer-roles)
    - [At the Competition](#at-the-competition)
  - [Certificates, Medals, and Trophies](#certificates-medals-and-trophies)
    - [Arranging and Designing Certificates](#arranging-and-designing-certificates)
    - [Arranging Medals or Trophies](#arranging-medals-or-trophies)
    - [Prizes](#prizes)
  - [Making Groups](#making-groups)
    - [Balanced Groups](#balanced-groups)
    - [Speed-Based Groups](#speed-based-groups)
  - [Printing and Cutting](#printing-and-cutting)
    - [Score Sheets](#score-sheets)
    - [Name Tags](#name-tags)
    - [Other Printables](#other-printables)
  - [Competition Checklist](#competition-checklist)
- [Day of the Competition](#day-of-the-competition)
  - [Competitor Check-In](#competitor-check-in)
    - [At The Check-In Area](#at-the-check-in-area)
    - [How to Talk to First-Time Competitors](#how-to-talk-to-first-time-competitors)
    - [Interacting with Parents/Guardians](#interacting-with-parentsguardians)
    - [Checking In First-Time Competitors](#checking-in-first-time-competitors)
    - [Managing On-the-Spot Registrations](#managing-on-the-spot-registrations)
  ...
  - [Awards Ceremony and Competitor Recognition](#awards-ceremony-and-competitor-recognition)
- [After the Competition](#after-the-competition)
  - [Organizer Reflection](#organizer-reflection)
...
Anyone interested in organizing a WCA competition is welcome to get involved, but competition organizers must have the ability to run the event successfully. Organizers must meet certain requirements, such as knowing how competitions work, communicating effectively, and assembling a capable organization team. According to the [Code of Ethics](https://documents.worldcubeassociation.org/documents/Code%20of%20Ethics.pdf), Delegates can decline to work with potential organizers based on factors such as inexperience and already having an abundance of competitions in the region.

If you are interested in becoming a competition organizer, you are encouraged to volunteer at competitions first. Delegates appreciate those who willingly volunteer to help with judging, running, and scrambling. This will help you become familiar with competitions from a perspective beyond that of a competitor.

## How to Organize a Competition

All WCA competitions must be attended and overseen by at least one WCA Delegate. If you want to organize your own competition, contact your nearest Delegate. If they agree to work with you, they can help you with finding a suitable venue and date. If there is no Delegate near your area, you can contact the Regional or Senior Delegate in your region.

For more information on how to contact a Delegate, go to the [How to Form a Team and Contact a Delegate](#how-to-form-a-team-and-contact-a-delegate) section.

## Disclaimer about Regional Differences

The WCA operates globally. Practices tend to differ from region to region. Certain sections or nuances might not apply to your region, although this handbook reflects the most common global practices.
...
Delegates are ultimately responsible for ensuring that every organizational task is completed by the time the competition begins and the competition follows all WCA Policies and Regulations. As a non-WCA Volunteer, Community organizers must follow instructions provided by their Delegate. Delegates can limit the tasks Community organizers perform.
...
Delegates are recommended to create a contract with Community organizers that sets clear expectations and responsibilities. This helps ensure organizers do not accidentally break a WCA Policy or Regulation or do things that reflect poorly on the WCA.

When an organization team consists of multiple Community organizers, they are all expected to contribute to the success of the competition. The Delegate may remove Community organizers who are not fulfilling their duties from the organization team.

Not everyone who performs organizer tasks must be listed on the competition page, at the discretion of the Delegate. Substantial contributions are typically needed to be listed as an organizer. For example, merely suggesting a competition idea or a venue is insufficient to be listed as a competition organizer.
...
The subject of the email should be short and straightforward. When you are initiating an email, include the competition name in the subject to let the recipients know what the email is about. The subject is essential when there are several upcoming competitions in the region.
...
The body is the message you want to convey. Avoid using long sentences without punctuation, and avoid writing using all uppercase letters, all bold, or all underlined. You should only use **bolding**, <u>underlining</u>, or _italicizing_ to emphasize the important keywords in a sentence or key sentences in a paragraph.

Stick to the subject. For example, if the subject mentions groups, you should write about groups in the email. Add a hyperlink whenever you are linking information from a website. Hyperlinks will prevent the recipients from wasting time searching for the webpage or landing on the wrong one. For example, recipients might find information on “XX Open 2025” and mistake it for “XX Open 2026”.
...
If English is not widely spoken in the competition’s region, you should consider translating the essential points in communications to the competitors into local languages. Sometimes you might need to send entire emails in multiple languages. If you do not speak one of the local languages, find someone who does and can help you translate. Depending on where you are, you might also want or need to include languages from neighboring countries.
...
Delegates are official representatives of the WCA whose main purpose is to oversee competitions on behalf of the organization and ensure they follow the WCA Regulations, Policies, Purpose, and Values. Every competition must have at least one Junior or Full Delegate present.

Here is the [complete list of Delegates](https://www.worldcubeassociation.org/delegates). Prioritize choosing a Delegate who lives close to the competition venue. If the local Delegate is unavailable for the competition, they should provide next steps or connect you with another Delegate who can help. If there is no Delegate in your region, you can contact your Regional or Senior Delegate so that they can try to help you find a Delegate to make your competition official.
...
Please remember that a Delegate has the authority to reject your competition for various reasons listed in the [Code of Ethics](https://documents.worldcubeassociation.org/documents/Code%20of%20Ethics.pdf). This can include your current level of experience, the current frequency of competitions in the region, or their own availability.
...
Contacting people with prior organizing experience can help you transition smoothly into organizing. A Delegate can also list themselves as an organizer to make it clearer that they intend to help with organizer tasks. However, they may still do organizer tasks as a listed Delegate without being separately listed as an organizer.
...
Your Regional Organization (RO) is another important group to contact when forming a team. ROs play an important role in organizing competitions by assisting organizers, managing finances, and coordinating equipment, among many other tasks. Each RO operates differently and can have different functions than other regions. Not all regions have an RO. Here is the [list of all officially recognized ROs](https://www.worldcubeassociation.org/organizations) on the WCA website. If your region does not have a suitable RO, the competition Delegates will manage these tasks.
...
There are many ways to find a venue. If a venue fits the needs of a cubing competition well, it might become a regular venue for your region.

To determine whether a venue is suitable, read the [Venue Setup](#venue-setup) section as it will give you a better understanding of the space’s actual size once you factor in equipment and setup. If a Regional Organization (RO) is active in your region, please contact them before reaching out to any venue.
...
Discuss with your RO and/or Delegates how many people might realistically attend a competition in your region. This can help you estimate roughly how much space you should look for if you have not already identified a good venue. A good rule of thumb is to budget at least four square meters per competitor.
...
The size, shape, and location of a venue directly affect how well the competition runs. Abnormally shaped rooms or setups can disrupt the flow of the competition and make it run behind schedule. Additionally, venues that are too small for the number of attendees can make the competition atmosphere uncomfortable.
...
To avoid unsuitable venues, consider the typical atmosphere of competitions you have previously attended. For example, a venue or room right next to a concert or other very loud noise does not provide a suitable competitive environment, especially if the competition is holding quiet events. Similarly, room temperature can affect focus and performance. In climates that can be very warm or very cold, consider whether the venue has heating, fans, or air conditioning.

## Running and Judging Systems

Organizers and Delegates can choose from several running and judging systems for your competition. Some regions prefer certain running systems. This document guides you through the most common systems used worldwide.
...
Seated judges are also known as “stationary judges” or “fixed judges”. They can be used in stationary or non-stationary rounds. They sit next to the solving station throughout the entire group. They do not call competitors to their stations. When a competitor finishes their attempt, the judge signals the runner to come over, typically by holding up a cover with the solved puzzle and score sheet.

#### Runners in Non-Stationary Rounds

In a non-stationary round, runners pick up puzzle covers with scrambled puzzles from the scrambling area, identify the competitors (i.e. call their name), drop off the cover and puzzle at a vacant solving station, and direct the competitor to that station.
...
When runners are used, stations should be numbered. This eases the runner’s job by letting them call the competitor to a specific station or identify the station where the competitor is seated.

#### Running Judges in Stationary Rounds
...
Many factors play into the system chosen for a competition, such as a lack of volunteers or a lack of space or chairs to have a waiting area. Always listen to your Delegates’ advice on which system will best suit your competition.

### Scramble Secrecy

The running and judging system you choose directly affects the measures needed to enforce scramble secrecy. For stationary rounds with running judges, scramble secrecy can be especially challenging as competitors could be tempted to watch each other solve when the judges are not present. The [WCA Scramble Accountability Policy](https://documents.worldcubeassociation.org/documents/policies/external/Scramble%20Accountability.pdf) (WSAP) recommends having someone such as a Delegate supervise competitors during stationary rounds.

## Venue Setup

Since many people will be in the venue for several hours, a well-set-up venue will not only improve competitors’ and guests’ experience but also save you from many logistical problems.

You must have the venue set up before the competition starts. This might take a significant amount of time. This includes moving the tables and chairs and setting up the equipment.

You might also need to modify the setup from one event to the next. For example, you might place papers and stopwatches out on a side stage for Fewest Moves, or set aside regular puzzle covers and bring out special covers for Clock.

### Definitions

Before going through the details of each area, here are a few definitions you should be aware of:

- The **score-taking table** is where the results are entered into Integrated Live Results. These results let competitors know their ranking and help you determine who advances to the subsequent rounds and who achieves podium placements.
...
- The **solving stations** are the tables where competitors do their solves. During stationary rounds, competitors also wait between solves at the solving stations.
- The **waiting area** is where competitors wait between solves in a non-stationary round.

### Check-in Area

The check-in area is the table where competitors verify their presence before entering the competition space. The ideal location for the check-in area is close to the venue door, such as at the entrance or in an adjacent hallway or lobby. Placing the check-in area in any of these locations helps competitors spot it before they enter the competition space.

### Competition Area

The competition area is where the solving stations are set up and competitors complete their solves. This usually consists of an array of tables with timers and mats functioning as competing stations. Many competitions use timer displays so the audience can see competitors’ times.
...
Each solving station must have adequate, consistent conditions. Each station should have sharp, consistent lighting along with a comfortable temperature (ideally 20 to 25 degrees Celsius). These factors directly affect competitors’ color recognition and turning ability. Different conditions at different stations could give some competitors an advantage or disadvantage.

Arrange the stations so the audience can see most of them. When using multiple rows, consider staggering them or raising the tables in the back onto a small stage so most stations are visible to the audience.
...
It is highly recommended that each solving station is numbered. This makes it easier for competitors, organizers, runners, judges, and Delegates to know where they need to go at a given time.
...
Every competition must follow the [WCA Scramble Accountability Policy](https://documents.worldcubeassociation.org/documents/policies/external/Scramble%20Accountability.pdf) (WSAP). Organizers and Delegates must be familiar with the WSAP and ensure their competition abides by it.

### Score-Taking Table

The score-taking table is where results are managed and entered into a score-taking platform. If results are double-checked during the competition, this typically happens at the score-taking table. Once a batch of score sheets has been entered and checked, they are organized and stored.

At smaller competitions, the score-taking table could be combined with the scrambling table. This would allow completed score sheets to be immediately given to the score takers. At larger competitions, it is better to have the score-taking table in a separate area or room reserved for volunteers.
...
Stanchions can help with crowd control. Some ways that you can use stanchions are to prevent people from coming within 1.5 meters of solving stations while they are in use, to separate the competition area from non-competition areas, and to create a line for the check-in table.

Posters can provide information to competitors and spectators. Here are a few ways they can be used:

- Remind people of what they should and should not do (e.g. please stay quiet during blindfolded events, do not use flash photography, stay 1.5 meters away from competitors while they are competing).
- Label important areas (e.g. waiting area, quiet room, spectator seating).
...
Flyers can also provide information about your competition to spectators and competitors. Flyers can answer some frequently asked questions that your local community might have, to alert competitors about future competitions in the area, and/or to direct competitors to online resources.
...
- Does the venue require liability insurance coverage?
- Do you need to pay the venue to set up anything?
- Is there an additional fee for having venue employees present during the competition?
...
Registration fees are the most common source of income for competitions. If you rely on registration fees, estimate the minimum number of paying competitors you expect when calculating the expected revenue. Waiving registration fees for competitors must follow item 1.3 of the [Code of Ethics](https://documents.worldcubeassociation.org/documents/Code%20of%20Ethics.pdf).
...
To lower registration fees, you could sell merchandise (e.g. shirts, mugs, or bags), enable donations on the registration site, or receive financial help from sponsors (e.g. cube stores, local companies, or the venue offering a reduced rate). If you plan to sell merchandise during the competition, check whether sales are allowed inside the venue. Remember that local laws might prohibit you or make it financially unsustainable (e.g. due to taxes or fees) to sell merchandise.
...
After calculating the estimated expenses, you can determine how much you need to collect from registration fees while leaving some margin in case you do not fill all registrations. In the example above, the organization team is planning to collect $1675 from registration fees. If the competitor limit is 60, then they will need to charge roughly $28 (1675/60) for registration. To account for mishaps or fewer registrations, they should charge $30 or $35.
...
One of the most significant decisions an organizer makes when creating the webpage is choosing which events to hold. Choosing the right events and the right number of events is a step toward a successful competition.

The size and duration of your competition will substantially affect how many events you can hold. A multi-day competition will typically hold more events than a one-day competition. A competition with 200 competitors will typically hold fewer events than a competition with only 30 competitors.

Competitions with events that have multiple rounds will generally fit fewer events into the schedule. If you want to hold events with multiple rounds, consider reducing the number of events to avoid an overcrowded schedule. A full-day competition with 100 competitors can typically hold four to six events.
...
These details are not specific to any event. However, you must consider all of these when creating your competition’s schedule:
...
Leave enough time at the start of your competition to check in every competitor. If you allow on-the-spot registrations, you will also need to factor that in. Ensure the time scheduled for on-the-spot registrations and check-in is appropriate based on the number of registered competitors. Do not schedule only 10 minutes if you have over 100 competitors registered. There will likely be a large number of competitors arriving just before the main event, so ensure you consider the time and resources needed to check in all those competitors.
...
Although some people travel by car for lunch, other competitors and spectators might need to walk. Consider the time it takes to walk to a restaurant, get food, and return to the competition venue. Check that there are multiple food options nearby to prevent everyone from eating at the same crowded place and to provide options for competitors with dietary restrictions.

Some people might choose to bring food or order food delivery, especially when the lunch options are too far to walk to. Make it clear on the competition website whether the venue allows food inside.
...
If the organization team provides the only lunch option available, do your best to accommodate people with dietary restrictions, such as allowing them to request their preferred food in advance.

#### Announcements, Tutorials, and Awards

Include planned announcements on the schedule. Examples include a talk about the sponsors, some relevant information about the competition, competitor tutorials, and judging tutorials.

Tutorials will usually take place at the start of the competition, just before the main event, or both. They typically take between 5 and 10 minutes. You do not need to cover every single detail in the tutorials. You only need to cover enough so that everyone understands the basics. Invite competitors to ask questions that were not covered in the tutorials.

If you are holding an awards ceremony, it could add 5 to 20 minutes to your competition after all the rounds have finished. You will also need a buffer in the schedule to finish entering and checking results and prepare certificates.

#### Length of Rounds

Just because another competition held a specific event in X time doesn’t mean it can always be held in that time. Here are some factors that affect how long a specific round takes:
...
Ensure that between two rounds of the same event, you have enough time to enter the previous round’s results and do any preparation you need (e.g. making groups and preparing score sheets for the subsequent rounds). An exception to this rule is Dual Rounds, in which you do not need to enter the results of the first round before the second round begins.

#### Simultaneous Rounds

You can hold multiple events at the same time, but you should not do this if you do not have much experience organizing competitions. Although simultaneous events let you hold more events in less time, they also require a larger venue, more equipment, and more volunteers. Since there must be a Delegate overseeing every area where an official event is taking place, you need multiple Delegates if you are using separate rooms.

A side room is typically used for long quiet events, namely 3x3x3 Fewest Moves, 4x4x4 Blindfolded, 5x5x5 Blindfolded, and 3x3x3 Multi-Blind.

#### Finalizing the Schedule

Once you have an initial draft of the schedule, work with your Delegates to refine it and ensure it fits the local community. This includes, but is not limited to:
...
If you use an external website, you will need to import registrations to the WCA website for these tools to work. Regardless of the website you use, the process will be similar.
...
- **Approved Registrations:** Registrations that have been completed and accepted. These competitors are eligible to compete. This is the list of registered competitors.
...
A pre-competition email that serves as an information packet can give competitors an idea of what to expect from the competition. Sending this email in multiple languages can be helpful or necessary in some regions.
...
Reliable, competent, and hard-working volunteers are essential to keep your competition running smoothly and minimize incidents. Here are some methods for assigning volunteer roles:
...
A dedicated volunteer team is different from pre-assigning volunteer roles to competitors. With dedicated volunteers, you will have a hand-picked group of people who will work throughout the entire competition, often receiving perks in exchange for their work (e.g. waiving their registration fee per item 1.3 of the [Code of Ethics](https://documents.worldcubeassociation.org/documents/Code%20of%20Ethics.pdf)).

You can incentivize competitors to join a dedicated volunteer team. Incentives can include free or discounted registration fees, meals, apparel, or lodging. Make volunteer incentives public before the day of the competition to promote transparency and recruit more volunteers. Organizers should discuss volunteer incentives with Delegates to ensure local competitions in the same area have consistent volunteer-recruiting practices. Using volunteer incentives in an area that previously did not use them could reduce intrinsic motivation to volunteer at competitions. When using volunteer incentives, organizers should ensure volunteer team members perform their duties adequately.

You can consider using volunteer groups for the main event or if you have many people registered in a round (e.g. 3x3x3 Cube First Round). A volunteer group involves all dedicated volunteers competing at the same time just before the round is about to start. This keeps all dedicated volunteers available to work during the remaining groups of that round. However, avoid doing this for too many rounds in a single competition, as it will most likely cost more time than splitting volunteers across all groups. Also, if you hold volunteer groups at any time other than the regular groups for logistical reasons (e.g. during lunchtime), make this clear on the competition schedule.

Registering as a volunteer and performing some duties does not automatically entitle someone to receive full benefits. Monitor each volunteer during the competition and take note of whether they are performing their assigned duties. If volunteer incentives reduce volunteer quality, consider pre-assigning duties to competitors next time.
...
Every approach to assigning volunteer roles has its own advantages and disadvantages. However, you can carefully combine methods at a competition. Having dedicated volunteers for the main event and having some competitors fulfill volunteer duties too during other events might work well. Another option is to assign more important roles (i.e. scramblers) to trusted people and let others fill the remaining roles. Remember that these are not the only combinations possible.

It can be difficult to know who will proceed to subsequent rounds, so do not take chances on specific competitors not advancing.
...
2. **Scramblers** should be trustworthy people to avoid incorrect scrambles. If possible, assign faster competitors to scramble, as they can scramble the puzzle more quickly and often with more accuracy. Faster competitors can also help when a scramble is incorrect because they can solve the puzzle faster. If you are pre-assigning scramblers, you should let your Delegate review the list of scramblers before the competition.
3. **Runners** should be aware of their surroundings and be able to handle puzzles with care. They watch for competitors finishing their solves and puzzles being scrambled to efficiently transfer puzzles between solving stations and the scrambling table. If possible, runners should also take multiple puzzles at the same time for efficiency. When the round is non-stationary, runners should be people who are not too shy, as they should call competitors’ names loudly and clearly so that the competitors can hear them. Runners should be confident in enunciating names to the best of their ability. If a runner is not confident in a name’s pronunciation, they should learn it by asking the competitor directly. Familiarity with the competitors can help, but it is not mandatory.
...
When all first-time competitors are in the first group, you can move those who show up late, take a long time to solve the puzzle, or get many extra attempts to the next group. When first-time competitors are all in the last group, they have more time to watch other groups compete first, which can result in fewer extra attempts caused by inexperience.
...
If you are pre-assigning volunteer roles, you can print out an overview of who is scrambling, judging, and running. This is available on [Competition Groups](https://competitiongroups.com/).

Schedules and schedule trackers are also useful to print. If you maintain a schedule tracker, you can use it to adjust the schedule after the competition to reflect when each round actually took place. This is useful for future competitions at the same venue.
...
Parents/guardians will often have questions about the competition, whether it’s how to view their child’s results online, how many competitors advance to subsequent rounds, or how the competition runs. Answer with a helpful, complete response. If you cannot answer a question, pass it on to someone who can. Be polite and friendly, so they enjoy your competition and want to attend more.
...
The organizer in charge of the venue, likely the main organizer, will be asked many questions throughout the day by competitors, parents/guardians, and spectators about the venue (e.g. the location of the restrooms and nearby places to get coffee). They are also responsible for addressing any venue-related issues that arise, including contacting the venue owner when necessary. They manage keys and ensure people can access the venue. They should ensure there are enough chairs and tables for everyone.
...
You must have someone enter the results throughout the competition. This does not need to be the same person for the entire competition, but it is often the same few people. If you are the main organizer, do not always assign this to yourself, as you will be busy with other duties and overseeing the competition when concerns arise. If your organization team is large, assign someone other than the main organizer to do score-taking.

Enter results in a timely and accurate manner so competitors can see how they ranked, and so you have enough time to prepare score sheets for subsequent rounds. If results are not entered promptly, it can delay the start of a subsequent round as there will not be enough time to prepare score sheets.

Have someone other than the designated score taker double-check the results so they can be submitted at the end of the competition. Otherwise, the Delegates will spend hours double-checking the results after the competition. Double-checking throughout the day is better than doing it after the competition because it prevents significant score-taking mistakes that could send the wrong competitors to subsequent rounds or award prizes incorrectly.
...
Competitors’ achievements and work can be recognized with awards, prizes, or honors. Achievements to qualify for awards, prizes, or honors include the following:
...
For more details on awards, refer to the [Certificates, Medals, and Trophies](#certificates-medals-and-trophies) and [Prizes](#prizes) sections.
...
If you notice anything running exceptionally well, take notes so you can try to replicate it in the future. Try to note everything you think is notable, including equipment in use, specific people fulfilling volunteer duties, systems in use, competition layout, or group organization.
...
You can get feedback from lots of people, so just ask! Competitors, volunteers, co-organizers, and the Delegates are good people to ask. Receiving feedback can help you better understand how your competition ran.
...
- Were there any common incidents? If so, can we make changes to reduce them?
...
A great way to get feedback from Delegates and co-organizers is to hold a post-competition discussion. You can do this in person or online. Dinners after the competition, online calls, or online messaging are some good ways to do this. These discussions should recognize strengths, identify shortcomings, and discuss things that could be done differently at future competitions to improve them.

Delegates must write a Delegate Report after each competition. The report includes how well the organization team did and how well the competition ran. Delegates are not obligated to share the contents of the report with Community organizers. However, you could still ask if there are any details they are willing to share that could benefit future competitions you organize.
