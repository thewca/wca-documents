...
The policies found in the Volunteer panel and Delegate panel are internal documents. There are also external documents on the [Documents page](wca{documents}) that are available to everyone.
...
There are many mailing lists, all of which have their dedicated audience and purposes. Every Committee/Team’s email addresses can be found on the [contact page of the WCA](wca{contact}), along with a brief description of their scope of work.
...
When you make changes to the recipients, make this clear at the top of the email. If there is a need to include another Committee/Team in the thread, begin by writing a “+” along with the name of the Committee/Team so everyone is aware. When removing someone from a thread, write a “-” followed by their name. For example:
...
When a recipient is removed and you would like to let them know the conversation will continue without them, move them to the BCC field, allowing them to see the last email go through. After that, they will not receive further emails on the thread.
...
Every WCA Volunteer is expected to demonstrate professionalism. Ensure you upload a suitable picture of yourself as your avatar. You can upload an avatar and see all the guidelines that apply to WCA Volunteers [here](wca{profile/edit?section=avatar}).
