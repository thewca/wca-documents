...
- A list of banned competitors can be found in the [Delegate panel](wca{panel/delegate#banned-competitors}). Only Junior Delegates and Full Delegates will have access to this list. If a competitor attempts to attend a competition when they are banned from doing so, please contact the WIC.
...
- In the Delegate Report, the WIC generally advises to maintain anonymity for all types of incidents, however this is not required for typical incidents (such as disruptions and simple 3BLD peeking incidents).
