...
Աշխրահի Կուբիկի Ասոցիացիան վերահսկում է Ռուբիկի Խորանարդի առաջնությունների աշխարհի բոլոր երկրներում։ ԱԿԱ-ի կողմից հաստատված բոլոր առաջնությունները պետք է հետևեն ԱԿԱ [Կանոնակարգերին](https://www.worldcubeassociation.org/regulations/) և [Ուղեցույցերին](https://www.worldcubeassociation.org/regulations/guidelines.html), այսինքն շատ կարևոր է որ դուք առաջնության գնալուց առաջ ծանոթ լինեք այդ կանոններին։
...
::::: {.box .important}
Եթե վստահ չեք ինչ-որ բանի մասին, միշտ հարցրեք Պատվիրակին!
:::::
...
- **Մասնակից**: Ձեր հիմնական դերը մասնակցելն է: Այուամենայնիվ, ձեզ նույնպես կարող են կանչել մրցավար լինելու համար, եթե դրա կարիքը լինի։
- **Մրցավար**: Մրցավարները վերահսկում են մասնակիցների փորձերր, որպեսզի դրանք անցնեն համաձայն Կանոնակարգերի։ Յուրաքանչյուր փորձի վերջում նրանք իրենց ստորագրությամբ հաստատում են, որ ամեն ինչ անցել է ըստ կանոնների։
...
- **Stackmat ժամաչափ**: Սա պաշտոնական սարքն է առաջնություններին ժամանակ պահելու համար։
...
- **Վայրկյանաչափ**: Վայրկյանաչափերն օգտագործվում են զննման ժամանակը չափելու համար։ Դրանք նաև օգտագործվում են 10 րոպեից երկար տևողությամբ փորձեևը չափելու համար։ Նշենք, որ վայրկյանաչափերը կարող են լինել տարբեր մոդելների և չհամապատասխանեն ստորև ներկայացված վայրկյանաչափի ֆունկցիոնալության հետ:
...
- **Կայանի մրցավարները** նստում են հավաքելու կայանում և լինում են մրցավար իրար հետևից մի քանի մասնակիցների համար։ Վազողները կվերցնեն փազլները խառնելու սեղանից, կկանչեն մասնակցին և կուղեկցեն ազտ կայանի մրցավարի մոտ։ Մրցավարի պարտականությունը սահմանափակվում է փազլը հավաքելը վերահսկելով։
...
### Հավաքելը սկսելը:
Յուրաքանչյուր փորձից առաջ մրցավարը պետք է վստահ լինի, որ ժամաչափը աշխատում է, միացված և ժամանակը զրոյացված է։

Երբ մասնակիցը նստում է հավաքելու կայանում, մրցավարը/վազողը ծածկած փազլը դնում է սեղանին և սպասում է մինչև մասնակիցը պատրաստ լինի սկսելու փորձը։

Համոզվելու համար մրցավարը մասնակցին հարցնում է “Պատրաստ?”
...
::::: {.box .attention}
Հիշեք! Մասնակիցն իրավունք չունի զննման ժամանակ կատարել որևէ քայլ փազլի վրա!
:::::
...
::::: {.box .attention}
Հիշեք! Հավաքել սկսելիս մասնակցի ձեռքերը պետք է լինեն տափակ, ձեռքերի ափերը ներքև և ժամաչափի սենսորին պետք է դիպչի մատներով և ոչ թե ձեռքի ափերով! (Տուգանք: +2 վայրկյան [A4b](http://wca.link/A4b))
:::::

### Հավաքելը դադարելը: {.page-break-before}
Երբ փազլը հավաքված է, մասնակիցը ժամաչափը դադարեցնում է իր ձեռքերը դնելով սենսորներին։ Նրանք չպետք է դիպչեն փազլին և ձեռքերը պետք է լինեն տափակ՝ ափերը ներքև։

::::: {.box .attention}
Հիշեք! Հավաքելն ավարտելիս մասնակցի ձեռքերը պետք է լինեն տափակ և ափերը ներքև! (Տուգանք: +2 վայրկյան [A6d](http://wca.link/A6d))
:::::

Մրցավարը ստուգում է փազլի հավաքվածությունը և մասնակցին ասում է արդյունքը; “OKAY”, “ՏՈՒԳԱՆՔ” կամ “DNF”։ Մասնակիցն իրավունք չունի դիպչել փազլին մինչև մրցավարի կողմից չհնչի վերջնական որոշումը։

::::: {.box .important}
Եթե ձեզ անհրաժեշտ է օգնություն որոշում կայացնելու համար, կամ ինչ-որ արտասովոր բան է տեղի ունեցել, խնդրում ենք անհապաղ դիմել ԱԿԱ Պատվիրակին։
:::::

::::: {.box .important}
Հիշեք! Տուգանքները կոտւակային են, այսինքն մեկ փորձի ժամանակ կարող եք ստանալ մի քանի +2 վայրկյան տուգանքներ։
:::::
...
## Կարևոր Կանոններ {.page-break-before}
...
[Կանոն A6)](https://www.worldcubeassociation.org/regulations/#A6)-ը բացատրում է ինչպես ճիշտ կանգնեցնել ժամաչափը։
...
- **Ձևաչափեր** Մասնակիցներին դասակարգելու համար կան արդյունքները հաշվելու տարբեր ուղիներ կախված կատեգորիայից։ Պաշտոնական ձևաչափերն են;
  ...
  - **X-ի լավագույն**: Յուրաքանչյուր մասնակից ունի X փորձ, որտեղ X-ը հավասար է 1, 2 կամ 3։ X արդյունքների միջից ամենալավ արդյունքը ընդունվում է որպես վերջնական։
