...
2. **Tool Selection by Data Classification:**
    1. **For Private Information:** WCA Volunteers must only use WCA-approved AI tools while logged into an official WCA account on the relevant platform. This ensures the data is not used to train external models.
